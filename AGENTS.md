...
- Enforce the manifest budgets: total precache no more than 5 MiB, presentation precache no more than 2 MiB, and lazy assets no more than 25 MiB. Count encoded delivery bytes, not source-master sizes. The 41 v4.7 formal SVGs total 105,047 bytes.
