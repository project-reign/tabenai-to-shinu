...
- Keep title, normal, warning, rare, conditional, milestone, final, death, escape, and achievement hooks available. A hook may trigger presentation only; it must not become a game-state transition.
...
- True rare uses day-based base chances of 0.8% on days 1–19, 1.0% on days 20–34, 1.2% on days 35–44, and 1.5% on days 45–49. Do not count conditional, milestone, or final encounters as true rare.
- Stop true-rare draws after two encounters. Soft pity applies only while `rareSeen === 0`, starts no earlier than day 35 after the corresponding dry streak, rises gradually, never exceeds a 4% effective chance, never guarantees a hit, and is disabled after the first true rare.
