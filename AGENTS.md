...
- Precache only the application shell and the small assets marked `precache` in `assets/manifest.json`. A missing lazy asset must fall back without interrupting play.
